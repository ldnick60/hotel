...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { dob: @user_info.dob, first_name: @user_info.first_name, last_name: @user_info.last_name, phone: @user_info.phone, user_id: @user_info.user_id } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { dob: @user_info.dob, first_name: @user_info.first_name, last_name: @user_info.last_name, phone: @user_info.phone, user_id: @user_info.user_id } }
